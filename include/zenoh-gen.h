...
typedef enum z_locality_t {
   ...
   */
  Z_LOCALITY_T_SESSION_LOCAL = 1,
  /**
   * Only from remote sessions.
   */
  Z_LOCALITY_T_REMOTE = 2,
} z_locality_t;
 ...
 */
ZENOHC_API
void zc_internal_create_transport(z_owned_transport_t *this_,
                                  struct z_id_t zid,
 ...
 */
ZENOHC_API
void zc_internal_create_transport_shm(z_owned_transport_t *this_,
                                      struct z_id_t zid,
                                      enum z_whatami_t whatami,
                                      bool is_qos,
                                      bool is_multicast,
